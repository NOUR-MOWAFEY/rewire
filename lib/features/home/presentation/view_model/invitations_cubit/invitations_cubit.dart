...
class InvitationsCubit extends Cubit<InvitationsState> {
  ...
  InvitationsCubit(this._firestoreService, this._userId) : super(InvitationsInitial()) {
    listenToInvitations();
  }
  ...
  void listenToInvitations() {
    ...
    _invitationsSubscription = _firestoreService.listenToInvitations(_userId).listen(
      (invitations) {
